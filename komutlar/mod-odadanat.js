...
if(!message.member.permissions.has('MOVE_MEMBERS')) return message.channel.send(new Discord.MessageEmbed().setTitle(`**• \`${client.ayarlar.prefix}at\` kullanmak için, \`Üyeleri Taşı\` İznine sahip olmanız gerekiyor.**`));
