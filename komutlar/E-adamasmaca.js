...
module.exports.run = async (bot, message, args) => {
        ...
        try {
            ...
            if (cevap.length === confirmation.length || tahmin) return message.channel.send(` <a:helal:812343763497517106> **Tebrikler kelimeyi buldun! Kelime** \`${cevap}!\``);
            return message.channel.send(`Maalesef bilemedin <:zgn:812354150062751744> Kelime: \`${cevap}\``);
        } catch (err) {
            oyndurum.delete(message.channel.id);
